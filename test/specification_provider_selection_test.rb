...
class SpecificationProviderSelectionTest < Minitest::Test
  ...
  def test_an_unconfigured_provider_resolves_to_the_operators_real_claude_profile
    provider = Provider.resolve(working_directory: working_directory, settings: settings_for({}), claude_profile: claude_profile, env: {})
  ...
  def test_an_unconfigured_provider_with_no_real_profile_refuses_with_both_remedies
    error = assert_raises(Provider::Unavailable) do
      Provider.resolve(working_directory: working_directory, settings: settings_for({}), claude_profile: nil, env: {})
    end
  ...
  def test_the_composer_is_still_available_when_it_is_explicitly_asked_for
    ...
    provider = Provider.resolve(working_directory: working_directory, settings: settings, claude_profile: claude_profile, env: {})
  ...
  def test_the_fake_alias_still_selects_the_composer_explicitly
    provider = Provider.resolve(working_directory: working_directory, settings: settings_for({ "provider" => { "kind" => "fake" } }),
  ...
  def test_an_explicit_claude_kind_selects_the_real_profile
    provider = Provider.resolve(working_directory: working_directory, settings: settings_for({ "provider" => { "kind" => "claude" } }),
  ...
  def test_an_explicit_claude_kind_without_a_profile_refuses
    error = assert_raises(Provider::Unavailable) do
      Provider.resolve(working_directory: working_directory, settings: settings_for({ "provider" => { "kind" => "claude" } }),
                       claude_profile: nil, env: {})
    end
  ...
  def test_the_provider_reports_a_kind_and_description_that_agree
    [ Provider.resolve(working_directory: working_directory, settings: settings_for({ "provider" => { "kind" => "composed" } }),
                       claude_profile: nil, env: {}),
      Provider.resolve(working_directory: working_directory, settings: settings_for({}), claude_profile: claude_profile, env: {}) ].each do |provider|
